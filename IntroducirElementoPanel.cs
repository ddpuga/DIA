...
namespace ReparacionesGrafico.UI
{
    ...
    class IntroducirElementoPanel : WFrms.Form
    {

        public IntroducirElementoPanel()
        {
            this.build();
        }
        ...
        private void build()
        {
            ...
            btTDT.Click += (sender, args) => new IntroducirAparatoPanel("tdt").Show();
            btRadio.Click += (sender, args) => new IntroducirAparatoPanel("radio").Show();
            btDVD.Click += (sender, args) => new IntroducirAparatoPanel("dvd").Show();
            btTV.Click += (sender, args) => new IntroducirAparatoPanel("tv").Show();
